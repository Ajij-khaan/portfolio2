...
const Header = () => {
    return (
        <Navbar id="home" className="global-bg" collapseOnSelect expand="lg" sticky="top">
            <Container className="fw-bold">
                ...
                <Navbar.Collapse className="justify-content-end text-dark">
                    <Nav className="ms-auto">
                        ...
                        <Nav.Link as={HashLink} to="/blogs" className=" fw-bold text-white">BLOGS</Nav.Link>
                        <Nav.Link as={HashLink} to="/#contact" className=" fw-bold text-white">CONTACT</Nav.Link>
                    </Nav>
                </Navbar.Collapse>
            </Container>
        </Navbar>
