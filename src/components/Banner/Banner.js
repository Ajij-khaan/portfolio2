      ...
      <Container>
        <Row className="text-start pt-5 d-flex align-items-center">
          <Col sm={12} md={6}>
            ...
            <h1 className="text-white pt-3" data-aos="zoom-in-right">
              I'M <span className="fw-bolder text-green">AJIJ KHAN.</span>
            </h1>
            <h1 className="text-white pt-3 fw-bolder" data-aos="zoom-in-right">
